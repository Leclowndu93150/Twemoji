...
public final class TwemojiFabricRegistries {
    ...
    private static final class ClientReloader implements IdentifiableResourceReloadListener {
        private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Twemoji.MOD_ID, "emoji_registry");
    ...
    private static final class ServerReloader implements IdentifiableResourceReloadListener {
        private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Twemoji.MOD_ID, "server_emoji_loader");
